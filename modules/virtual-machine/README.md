...
| <a name="input_disks"></a> [disks](#input\_disks) | n/a | <pre>list(object({<br/>    auto_delete     = optional(bool, true)<br/>    boot_order      = number<br/>    bus             = optional(string, "virtio")<br/>    hot_plug        = optional(bool, false)<br/>    image           = optional(string, "")<br/>    image_namespace = optional(string, "")<br/>    name            = string<br/>    mount           = optional(string, "")<br/>    size            = string<br/>    type            = optional(string, "disk")<br/>  }))</pre> | `[]` | no |
